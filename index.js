...
if(message.author.bot) return;
  ...
  if (message.content.match(prefixMention)) {
    ...
    .setImage("https://media.discordapp.net/attachments/909147436130385930/912959817356832918/standard.gif")
    .setDescription(`Hello! I'm ${client.user.username}, A Multipurposed Bot, Created By <@909123412054638653> My Prefix In The Server Is \`${prefix}\` Searching For My Commands? Try To Do \`${prefix}help\``)
    .setColor("RANDOM");
...
client.on("ready", () => {
    ...
    console.log(`${client.user.username} was turned on || Join TimesCord Community| https://discord.gg/wkUCxNbsXs`)
});
